		...
		<>
			<div
				...
				<VSCodeButton
					...
					onClick={onPlusClick}
					style={buttonStyle}
					onMouseEnter={(e) => showTooltip(t("navbar.newChat"), e, "center")}
					onMouseLeave={hideTooltip}
					onMouseMove={(e) => showTooltip(t("navbar.newChat"), e, "center")}>
				...
				<VSCodeButton
					...
					style={buttonStyle}
					onMouseEnter={(e) => showTooltip(t("navbar.history"), e, "center")}
					onMouseLeave={hideTooltip}
					onMouseMove={(e) => showTooltip(t("navbar.history"), e, "center")}>
				...
				<VSCodeButton
					...
					onMouseEnter={(e) => showTooltip(t("navbar.settings"), e, "right")}
					onMouseLeave={hideTooltip}
					onMouseMove={(e) => showTooltip(t("navbar.settings"), e, "right")}>
